...
def cover():
    print """
     ...
     """
    runntek(GL+"   El conocimiento es libre ")
    time.sleep(1)
    print " "
    print RR+"  +====================================+"
    print GG+"  |https://sefirot-gear-studio.es.tl/  |"
    print RR+"  +====================================+"
    print RR+"  +====================================+"
    print GG+"  |   hack facebook creardo por samuel |"
    print RR+"  +====================================+"     
...
passwordlist = str(raw_input(WW+" Ingrese el archivo de Contraseñas\033[95m[escribe > pass.txt, para iniciar] \033[92;1m: "))
...
def main():
        ...
        search()
        print " "
        runntek(RR+" Lista de palabras Nada coincide")
        runntek(RR+"  Desarrolle su propia lista de palabras Cuk")
        time.sleep(1)
        print WW+34*"  -"
        kol()
